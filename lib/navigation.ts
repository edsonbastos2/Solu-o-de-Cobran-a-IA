import { Bot, Cpu, FolderKanban, Handshake, LayoutDashboard, Settings, Shield, Users } from 'lucide-react';
...
export const navConfig: NavSection[] = [
  ...
  },
  {
    ...
    label: 'Configuração',
    items: [
      { label: 'Agentes IA', href: '/agents', icon: Cpu, section: 'configuracao', dataTour: 'agents-nav' },
      { label: 'Políticas', href: '/policies', icon: Shield, section: 'configuracao', dataTour: 'policies-nav' },
