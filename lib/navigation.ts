import { Bot, Cpu, FolderKanban, Handshake, KanbanSquare, LayoutDashboard, MessageCircle, Settings, Shield, Users, ShieldAlert, MessageSquareText, FileUp, Ban, Landmark, Scale, Sparkles } from 'lucide-react';
...
export const navConfig: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: 'CRM', href: '/crm', icon: KanbanSquare, section: 'operacao' },
